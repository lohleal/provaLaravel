    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                @can('delete', $item)
                <a href="#" onclick="showRemoveModal('{{ $item->id }}', '{{ $item->nome }} - {{ $item->curso->nome ?? '' }}')" class="btn btn-outline-danger">
...
<a href="{{ route('login') }}" class="btn-voltar-login">🔙 Voltar para Login</a>
