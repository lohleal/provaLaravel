...
@section('conteudo')
    ...
    <table class="table align-middle caption-top table-striped">
        <thead>
            <th class="text-secondary">PRODUTO</th> {{-- agora mostra IMAGEM --}}
            <th class="text-secondary">NOME</th> {{-- agora mostra o nome do item --}}
            <th class="d-none d-md-table-cell text-secondary">CATEGORIA</th> {{-- antes era curso --}}
